...
knifer_rs::vstr::add_prefix_if_not_ignore_case = pub fn add_prefix_if_not_ignore_case(input: &str, prefix: &str) -> String
knifer_rs::vstr::add_suffix_if_not = pub fn add_suffix_if_not(input: &str, suffix: &str) -> String
knifer_rs::vstr::add_suffix_if_not_ignore_case = pub fn add_suffix_if_not_ignore_case(input: &str, suffix: &str) -> String
...
knifer_rs::vstr::common_prefix = pub fn common_prefix<'src>(left: &'src str, right: &str) -> &'src str
knifer_rs::vstr::common_suffix = pub fn common_suffix<'src>(left: &'src str, right: &str) -> &'src str
...
knifer_rs::vstr::difference = pub fn difference<'src>(left: &str, right: &'src str) -> &'src str
...
knifer_rs::vstr::rotate = pub fn rotate(input: &str, shift: isize) -> String
...
knifer_rs::vstr::wrap_if_missing = pub fn wrap_if_missing(input: &str, marker: &str) -> String
