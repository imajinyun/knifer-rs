...
require_text README.md 'vstr::unicode_words'
require_text README.md 'vstr::unicode_sentences'
require_text README.md 'vstr::display_width'
require_text README.md 'vstr::take_width'
require_text README.md 'vstr::truncate_width'
require_text README.md 'vstr::wrap_width'
...
require_text README.md 'vstr::WrapOptions'
require_text README.md 'vstr::WhitespaceMode::Preserve'
require_text README.md 'vstr::LongWordPolicy::Preserve'
require_text README.md 'vstr::wrap_with_options'
require_text README.md 'vstr::wrap_width_with_options'
...
require_text README.md 'vbytes::byte_len'
require_text README.md 'vbytes::is_utf8'
require_text README.md 'vbytes::sub'
require_text README.md 'vbytes::find_all'
require_text README.md 'vbytes::replace_all'
require_text README.md 'vencoding::detect_bom'
require_text README.md 'vencoding::strip_bom'
require_text README.md 'vencoding::validate_utf8_without_bom'
require_text README.md 'vencoding::decode_utf8_lossy_without_bom'
...
require_text docs/top-rust-utility-gap-analysis.md 'semver-aware API checks'
require_text docs/top-rust-utility-gap-analysis.md 'cargo-semver-checks'
require_text docs/top-rust-utility-gap-analysis.md 'bin/check-release-api-semver.sh'
require_text docs/top-rust-utility-gap-analysis.md 'API_SEMVER_REQUIRED=true'
...
require_text docs/top-rust-utility-gap-analysis.md 'bash bin/check-api-semver.sh'
...
require_text docs/vstr-top-string-gap-analysis.md 'Roadmap'
...
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-GAP-003: Complete'
...
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-GAP-016: Complete'
require_text docs/vstr-top-string-gap-analysis.md '`vbytes` Facade'
...
require_text docs/vstr-top-string-gap-analysis.md '`vencoding` Facade'
...
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-GAP-001: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-001: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-004: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-005: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-006: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-007: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-008: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-009: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-010: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-011: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'docs/vstr-benchmark-history.md'
require_text docs/vstr-top-string-gap-analysis.md 'docs/vstr-matcher-backend-plan.md'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-GAP-004: Complete'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR_BENCH_BASE_REF'
require_text docs/vstr-top-string-gap-analysis.md 'vstr-bench-compare.json'
...
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-001'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-002'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-003'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-004'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-005'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-006'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-007'
require_text docs/vstr-top-string-gap-analysis.md 'VSTR-TODO-009'
