...
require_text Cargo.toml 'memchr = { version = "2", optional = true }'
...
require_text Cargo.toml 'search-memchr = ["dep:memchr"]'
...
require_text README.md 'kniferrs::vstr'
require_text README.md 'kniferrs::vbytes'
require_text README.md 'kniferrs::vencoding'
...
require_text README.md 'use kniferrs::{vbytes, vencoding, vstr};'
...
require_text docs/dependency-policy.md '`search-memchr` Admission Contract'
require_text docs/dependency-policy.md 'The default build must not depend on `memchr`'
...
require_text docs/api-behavior-contract.md 'kniferrs::vstr'
require_text docs/api-behavior-contract.md 'kniferrs::vbytes'
require_text docs/api-behavior-contract.md 'kniferrs::vencoding'
...
require_text docs/public-api-inventory.md 'kniferrs::vbytes'
require_text docs/public-api-inventory.md 'kniferrs::vbytes::byte_len'
require_text docs/public-api-inventory.md 'kniferrs::vbytes::is_utf8'
require_text docs/public-api-inventory.md 'kniferrs::vbytes::to_str'
require_text docs/public-api-inventory.md 'kniferrs::vbytes::find_all'
require_text docs/public-api-inventory.md 'kniferrs::vbytes::replace_all'
require_text docs/public-api-inventory.md 'kniferrs::vencoding'
require_text docs/public-api-inventory.md 'kniferrs::vencoding::Bom'
require_text docs/public-api-inventory.md 'kniferrs::vencoding::detect_bom'
require_text docs/public-api-inventory.md 'kniferrs::vencoding::strip_bom'
require_text docs/public-api-inventory.md 'kniferrs::vencoding::validate_utf8'
require_text docs/public-api-inventory.md 'kniferrs::vencoding::decode_utf8_lossy'
require_text docs/public-api-inventory.md 'kniferrs::vstr'
...
require_text src/vbytes.rs '#[cfg(feature = "search-memchr")]'
...
require_text src/vstr/text.rs 'callers keep importing through `kniferrs::vstr`'
...
require_text src/vstr/width.rs 'callers keep importing through `kniferrs::vstr`'
...
require_text fuzz/Cargo.toml 'kniferrs = { package = "knifer-rs", path = ".." }'
